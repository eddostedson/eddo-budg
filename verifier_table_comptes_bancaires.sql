-- ═══════════════════════════════════════════════════════════════════════════
-- Script de vérification et création de la table comptes_bancaires
-- ═══════════════════════════════════════════════════════════════════════════
-- 
...
WHERE table_name = 'comptes_bancaires'
ORDER BY ordinal_position;

-- 2. SI LA TABLE N'EXISTE PAS, CRÉER LA TABLE COMPTES_BANCAIRES
...
-- 3. CRÉER LA TABLE TRANSACTIONS_BANCAIRES
...
-- 5. FONCTION POUR METTRE À JOUR LE SOLDE AUTOMATIQUEMENT
...
-- 6. FONCTION POUR CALCULER LE SOLDE AVANT/AFTER
...
-- 8. FONCTION POUR UPDATED_AT (si elle n'existe pas déjà)
...
-- 11. CRÉER LES POLITIQUES RLS POUR COMPTES_BANCAIRES
...
-- 12. CRÉER LES POLITIQUES RLS POUR TRANSACTIONS_BANCAIRES
...
SELECT 
    '✅ TABLES CRÉÉES' as info,
    'transactions_bancaires' as table_name,
    COUNT(*) as nombre_colonnes
FROM information_schema.columns 
...
BEGIN
  ...
  RAISE NOTICE '🏦 Table comptes_bancaires créée';
