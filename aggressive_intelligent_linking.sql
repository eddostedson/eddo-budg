-- Script de liaison intelligente plus agressif
-- Tolérance plus large et combinaisons plus complexes
...
BEGIN
    RAISE NOTICE 'Début de la liaison intelligente agressive...';
    ...
    RAISE NOTICE 'Liaison intelligente agressive terminée: % dépenses liées', total_liees;
END $$;
