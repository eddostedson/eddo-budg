// 🎨 PAGE DE PRÉVISUALISATION - DESIGN RECTANGULAIRE AVEC BANDE LATÉRALE
'use client'
...
import { Loader2, RefreshCwIcon, CheckCircle, XCircle, AlertTriangle } from 'lucide-react'
import RecetteCardEnhanced from '@/components/recette-card-enhanced'
import { toast } from 'sonner'

const PreviewDesignRectangulairePage: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center">
        ...
        >
          ...
          <p className="text-gray-500 mt-2">Préparation du nouveau design rectangulaire</p>
        </motion.div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-4xl font-bold mb-2">🎨 Aperçu Design Rectangulaire</h1>
              <p className="text-blue-100 text-lg">Nouveau format avec bande latérale colorée</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        >
          <h2 className="text-xl font-bold text-gray-800 mb-4">🎨 Légende des Couleurs</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center space-x-3">
              <div className="w-4 h-4 bg-gradient-to-b from-green-700 to-green-800 rounded"></div>
              <div>
                <div className="font-semibold text-green-700">🟢 Disponibilité Élevée</div>
                <div className="text-sm text-gray-600">50% - 100% du budget</div>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-4 h-4 bg-gradient-to-b from-orange-600 to-orange-700 rounded"></div>
              <div>
                <div className="font-semibold text-orange-600">🟠 Disponibilité Moyenne</div>
                <div className="text-sm text-gray-600">15% - 49% du budget</div>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-4 h-4 bg-gradient-to-b from-red-600 to-red-700 rounded"></div>
              <div>
                <div className="font-semibold text-red-600">🔴 Disponibilité Faible</div>
                <div className="text-sm text-gray-600">0% - 14% du budget</div>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white shadow-xl">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium opacity-90">🟢 Élevée</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-gradient-to-br from-orange-500 to-orange-600 text-white shadow-xl">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium opacity-90">🟠 Moyenne</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-gradient-to-br from-red-500 to-red-600 text-white shadow-xl">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium opacity-90">🔴 Faible</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        >
          <div className="bg-white rounded-2xl p-6 shadow-lg">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">🎨 Aperçu du Nouveau Design Rectangulaire</h2>
            <p className="text-gray-600 mb-6">
              Chaque tuile présente maintenant une <strong>bande latérale gauche colorée</strong> qui indique instantanément 
              le niveau de disponibilité du budget. Le design est plus compact et harmonieux.
            </p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {recettes.slice(0, 8).map((recette, index) => (
                <motion.div
                  key={recette.id}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
            ...
            {recettes.length > 8 && (
              <div className="text-center mt-6">
                <Badge variant="outline" className="text-lg px-4 py-2">
                  + {recettes.length - 8} autres recettes
                </Badge>
              </div>
            )}
          </div>
...
export default PreviewDesignRectangulairePage
