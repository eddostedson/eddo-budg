-- Script de liaison complète des dépenses aux recettes
-- Version améliorée avec correspondance intelligente
...
BEGIN
    ...
    RAISE NOTICE 'Début de la liaison: % recettes, % dépenses', total_recettes, total_depenses;
    ...
    LOOP
        ...
        -- Chercher les dépenses correspondantes (correspondance exacte)
    ...
    RAISE NOTICE 'Liaison terminée: % dépenses liées sur %', total_liees, total_depenses;
END $$;
